...
A simple online Bookshop management system built with MongodDB, Express.js and Node.js. [Click here](https://demo-Bookshop-system.herokuapp.com/) to see the application
